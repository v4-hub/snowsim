      ...
      <div className="space-y-4">
          ...
          <div className="h-20 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={history}>
                <Line type="monotone" dataKey="forwardVisibility" stroke="#34d399" strokeWidth={2} dot={false} isAnimationActive={false} />
        ...
        <div className="bg-slate-800/50 p-3 rounded-lg border border-slate-700/50 space-y-2">
          ...
          <div className="h-20 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={history}>
                <Line type="monotone" dataKey="reverseVisibility" stroke="#34d399" strokeWidth={2} dot={false} isAnimationActive={false} />
                <YAxis domain={[0, 100]} hide />
              </LineChart>
            </ResponsiveContainer>
          </div>
